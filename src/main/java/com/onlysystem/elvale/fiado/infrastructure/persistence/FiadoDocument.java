package com.onlysystem.elvale.fiado.infrastructure.persistence;

import org.springframework.data.mongodb.core.mapping.Document;
import java.util.UUID;

@Document(collection = "fiados")
public class FiadoDocument {
    ...
    public FiadoDocument(UUID id, UUID cuenta, double valorFio,
