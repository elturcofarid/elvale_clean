package com.onlysystem.elvale.establecimiento.infrastructure.persistence;
...
public class EstablecimientoDocument {
    ...
    public EstablecimientoDocument(UUID id, String nit, String razonSocial, String direccion, String telefono,
            String descripcion, String observaciones, String estado, String usuarioGestor, LocalDateTime fechaGestion,
